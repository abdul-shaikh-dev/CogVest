...
assert.match(get("results").textContent, /Market share 32.2%/);
...
assert.doesNotMatch(get("results").textContent, /Market share/);
...
assert.match(get("detail-content").textContent, /Share of market holdingsUnavailable/);
