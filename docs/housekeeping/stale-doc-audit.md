...
| `docs/design/v1-ui-mockup-plan.md` | Removed after June research redesign | Current V1 work now points to `DESIGN.md`, `docs/design/v1-screen-baseline.md`, `docs/design/v1-ux-research-baseline.md`, `docs/design/v1-research-preview/index.html`, and Figma issue #69 files. |
...
| Old visual mockups vs current baseline | `DESIGN.md`, `docs/design/v1-screen-baseline.md`, `docs/design/v1-ux-research-baseline.md`, `docs/design/v1-research-preview/index.html`, and `docs/design/figma/issue-69-v1-screens/code.js` | Older mockups are superseded by the accepted V1 screen baseline. |
